function  [sys, x0]  = CalcLimitesSim(t,x,u,flag,FreqIni,FuncaoBuscaLimites)
    ...
    % Só para ter no Simulink os mesmos cálculos dos limites dinâmicos calculados pela função
    %---------------------------------------------------------------------------------------------
...
% Função criada para não perder a formatação desejada na saída no Simulink (aos pares H/L  H/L e não HHHH  LLLLL)
