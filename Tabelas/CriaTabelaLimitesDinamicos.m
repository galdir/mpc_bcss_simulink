function CriaTabelaLimitesDinamicos
% Função para criar a tabela de limites dinâmicos à ser consumida pelo solver
% Deve er atualizada toda vez que recebermos novas tabelas DoBTP e DoSimulador
% Deve ser rodada após ser gerada a nova tabela do TabSimuladorContas.xlsx, que tem a tabela DoSimulador mas com maior resolução
