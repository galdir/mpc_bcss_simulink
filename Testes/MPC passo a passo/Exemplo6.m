% O Exemplo 6 é o mesmo exemplo 5, porém, evitando obstáculo
% Observar que evita o obstáculo em todas as predições futuras

Exemplo6_MontaSolver;    % Usaremos a montagem do solver criada no exemplo 5 para inserir nova restrição
