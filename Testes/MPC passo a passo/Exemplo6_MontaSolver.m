...
%Para o Exemplo 6, incrementa as restrições do obstáculo para todo o horizonte de predição N
for k=1:N+1     
    g=[g; (robo_r+obs_r) - sqrt((X(1,k)-obs_x)^2 + (X(2,k)-obs_y)^2) ];
end
...
disp('Montado o solver para o Exemplo 6')